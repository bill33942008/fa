...
### Local GPU rendering (ComfyUI only)

For higher quality videos, render on your local Windows GPU with ComfyUI and upload to server.
...
3. On local PC (ComfyUI on port 8000 + exported workflow JSON):
